...
TEST(Parallel_Deicstra, Test_ASSERT_NO_THROW) {
...
TEST(Parallel_Deicstra, Test_ASSERT_NO_THROW_2) {
    std::vector<std::vector<int>> b = {
                  {0, 1, 7, 6, 3},
                  {1, 0, 3, 5, 4},
                  {7, 3, 0, 10, 5},
...
TEST(Parallel_Deicstra, Test_ASSERT_NO_THROW_3) {
    std::vector<std::vector<int>> b = {
                  {0, 1, 7, 6, 3},
                  {1, 0, 3, 5, 4},
                  {7, 3, 0, 10, 5},
...
TEST(Parallel_Deicstra, Test_Deicstra_1) {
    std::vector<std::vector<int>> b = {
                    {0, 1, 7, 6, 3},
                    {1, 0, 3, 5, 4},
                    {7, 3, 0, 10, 5},
...
TEST(Parallel_Deicstra, Test_Deicstra_2) {
    std::vector<std::vector<int>> b = {
                    {0, 1, 7, 6, 3},
                    {1, 0, 3, 5, 4},
                    {7, 3, 0, 10, 5},
...
TEST(Parallel_Deicstra, Test_Deicstra_5) {
    std::vector<std::vector<int>> b = randomVectorDjikstra(50);
    ASSERT_NO_THROW(parallelDjikstra(4, b));
}

TEST(Parallel_Deicstra, Test_Deicstra_6) {
